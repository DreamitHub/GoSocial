...
public class StoryListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public StoryListAdapter(Context mContext, ArrayList<HashMap<String, String>> arrayList, MyOnClickListener mOnClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.r_story_list, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        itemViewHolder.storyUserImage.setImageDrawable(context.getDrawable(R.drawable.profile_pic));
        itemViewHolder.storyUserName.setText(hashMapArrayList.get(position).get("storyphotoname"));
